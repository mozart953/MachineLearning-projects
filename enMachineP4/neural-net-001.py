...
weights1 = np.random.randn(input_size, hidden_size) * 0.01  # Inicialización con pequeña escala
...
hidden_layer = np.dot(new_celsius, weights1) + biases1
hidden_layer = np.maximum(0, hidden_layer)
predicted_fahrenheit = np.dot(hidden_layer, weights2) + biases2
